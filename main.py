...
from telethon.errors import MessageIdInvalidError, MessageAuthorRequiredError, FloodWaitError
...
end_text = "ℹ️ Bᴏᴛꜱ Sᴛᴀᴛᴜꜱ Aʀᴇ Aᴜᴛᴏ-Uᴘᴅᴀᴛᴇᴅ Eᴠᴇʀʏ 3 Hᴏᴜʀꜱ." # default for end_message.
